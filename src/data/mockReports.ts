...
export const DEPARTMENTS = [
  ...
  { id: 'DRAIN', name: 'DRAIN', fullName: 'Drainage & Sewage Department',    type: 'drainage',    color: 'bg-purple-100 text-purple-800'},
  { id: 'ELECT', name: 'ELECT', fullName: 'Electricity Department',          type: 'electricity', color: 'bg-orange-100 text-orange-800'},
  { id: 'FIRE',  name: 'FIRE',  fullName: 'Fire & Emergency Services',       type: 'fire',        color: 'bg-red-100 text-red-800'      },
  { id: 'SEWAGE',name: 'SEWAGE',fullName: 'Sewage Treatment Department',     type: 'sewage',      color: 'bg-amber-100 text-amber-800'  },
  { id: 'ANIMAL',name: 'ANIMAL',fullName: 'Animal Control & Welfare Dept',   type: 'animal',      color: 'bg-lime-100 text-lime-800'    },
];
...
export const STAFF_ACCOUNTS: Record<string, { city: string; dept: string; password: string; name: string }> = {
  ...
  'drain.indore@nagarsetu.gov.in':  { city: 'Indore', dept: 'DRAIN',  password: 'staff123', name: 'DRAIN Indore'  },
  'elect.indore@nagarsetu.gov.in':  { city: 'Indore', dept: 'ELECT',  password: 'staff123', name: 'ELECT Indore'  },
  'fire.indore@nagarsetu.gov.in':   { city: 'Indore', dept: 'FIRE',   password: 'staff123', name: 'FIRE Indore'   },
  'sewage.indore@nagarsetu.gov.in': { city: 'Indore', dept: 'SEWAGE', password: 'staff123', name: 'SEWAGE Indore' },
  'animal.indore@nagarsetu.gov.in': { city: 'Indore', dept: 'ANIMAL', password: 'staff123', name: 'ANIMAL Indore' },
  ...
  'drain.ujjain@nagarsetu.gov.in':  { city: 'Ujjain', dept: 'DRAIN',  password: 'staff123', name: 'DRAIN Ujjain'  },
  'elect.ujjain@nagarsetu.gov.in':  { city: 'Ujjain', dept: 'ELECT',  password: 'staff123', name: 'ELECT Ujjain'  },
  'fire.ujjain@nagarsetu.gov.in':   { city: 'Ujjain', dept: 'FIRE',   password: 'staff123', name: 'FIRE Ujjain'   },
  'sewage.ujjain@nagarsetu.gov.in': { city: 'Ujjain', dept: 'SEWAGE', password: 'staff123', name: 'SEWAGE Ujjain' },
  'animal.ujjain@nagarsetu.gov.in': { city: 'Ujjain', dept: 'ANIMAL', password: 'staff123', name: 'ANIMAL Ujjain' },
  ...
  'drain.bhopal@nagarsetu.gov.in':  { city: 'Bhopal', dept: 'DRAIN',  password: 'staff123', name: 'DRAIN Bhopal'  },
  'elect.bhopal@nagarsetu.gov.in':  { city: 'Bhopal', dept: 'ELECT',  password: 'staff123', name: 'ELECT Bhopal'  },
  'fire.bhopal@nagarsetu.gov.in':   { city: 'Bhopal', dept: 'FIRE',   password: 'staff123', name: 'FIRE Bhopal'   },
  'sewage.bhopal@nagarsetu.gov.in': { city: 'Bhopal', dept: 'SEWAGE', password: 'staff123', name: 'SEWAGE Bhopal' },
  'animal.bhopal@nagarsetu.gov.in': { city: 'Bhopal', dept: 'ANIMAL', password: 'staff123', name: 'ANIMAL Bhopal' },
};
...
export const allCityReports: Report[] = [
  ...
  },
  {
    ...
    severity: 8, type: 'drainage', priority: 'high', hasUserUpvoted: false, assignedDept: 'DRAIN',
  },
  {
    id: 's15', title: 'Power outage in Scheme 54 - Electricity fault',
    description: 'Transformer failure causing power cuts for 200+ households in Scheme 54 area.',
    imageUrl: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400',
    media: [{ id: 's15-1', type: 'image', url: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400' }],
    district: 'Indore', ward: 'Ward 22 - Scheme 54', street: 'Scheme 54 Main Road', coordinates: { lat: 22.7512, lng: 75.8901 },
    distance: 1.4, timestamp: new Date(Date.now() - 7 * 3600000), aiTag: 'Electricity Issue', aiConfidence: 91,
    status: 'pending', upvotes: 47, comments: [],
    severity: 8, type: 'electricity', priority: 'high', hasUserUpvoted: false, assignedDept: 'ELECT',
  },
  {
    id: 's16', title: 'Stray dogs attacking pedestrians - Palasia',
    description: 'Pack of aggressive stray dogs near Palasia Square attacking morning walkers and school children.',
    imageUrl: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400',
    media: [{ id: 's16-1', type: 'image', url: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400' }],
    district: 'Indore', ward: 'Ward 14 - Palasia', street: 'Palasia Square', coordinates: { lat: 22.7210, lng: 75.8600 },
    distance: 0.5, timestamp: new Date(Date.now() - 3 * 3600000), aiTag: 'Animal Nuisance', aiConfidence: 94,
    status: 'acknowledged', upvotes: 61, comments: [{ id: 'c10', text: 'My child was bitten last week', timestamp: new Date(), author: 'Parent - Indore' }],
    severity: 9, type: 'animal', priority: 'high', hasUserUpvoted: false, assignedDept: 'ANIMAL',
  },
  {
    id: 's17', title: 'Sewage overflow - Vijay Nagar residential area',
    description: 'Raw sewage overflowing onto roads in residential colony. Health emergency for residents.',
    imageUrl: 'https://i.pinimg.com/736x/15/df/d1/15dfd142e3abbe1c12f55b8dbdb4a5b7.jpg?w=400',
    media: [{ id: 's17-1', type: 'image', url: 'https://i.pinimg.com/736x/15/df/d1/15dfd142e3abbe1c12f55b8dbdb4a5b7.jpg?w=400' }],
    district: 'Indore', ward: 'Ward 22 - Vijay Nagar', street: 'Vijay Nagar Colony', coordinates: { lat: 22.7520, lng: 75.8950 },
    distance: 1.2, timestamp: new Date(Date.now() - 9 * 3600000), aiTag: 'Sewage Problem', aiConfidence: 89,
    status: 'pending', upvotes: 53, comments: [],
    severity: 9, type: 'sewage', priority: 'high', hasUserUpvoted: false, assignedDept: 'SEWAGE',
  },
  {
    id: 's18', title: 'Fire hazard - Garbage dump burning near Rajendra Nagar',
    description: 'Uncontrolled fire at garbage dump near residential area. Smoke affecting breathing for residents.',
    imageUrl: 'https://i.pinimg.com/736x/e6/6a/0d/e66a0d8d5c93ef89b5e89da49a08bfa3.jpg?w=400',
    media: [{ id: 's18-1', type: 'image', url: 'https://i.pinimg.com/736x/e6/6a/0d/e66a0d8d5c93ef89b5e89da49a08bfa3.jpg?w=400' }],
    district: 'Indore', ward: 'Ward 18 - Rajendra Nagar', street: 'Rajendra Nagar Colony Road', coordinates: { lat: 22.7030, lng: 75.8700 },
    distance: 2.1, timestamp: new Date(Date.now() - 1 * 3600000), aiTag: 'Fire Hazard', aiConfidence: 96,
    status: 'pending', upvotes: 78, comments: [{ id: 'c11', text: 'URGENT! Please send fire brigade', timestamp: new Date(), author: 'Local Resident' }],
    severity: 10, type: 'fire', priority: 'high', hasUserUpvoted: false, assignedDept: 'FIRE',
  },
  ...
  {
    id: 's19', title: 'Electricity cable hanging dangerously - Freeganj',
    description: 'High-voltage cable sagging low over the road near Freeganj. Major electrocution risk.',
    imageUrl: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400',
    media: [{ id: 's19-1', type: 'image', url: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400' }],
    district: 'Ujjain', ward: 'Ward 11 - Freeganj', street: 'Freeganj Lane 3', coordinates: { lat: 23.1775, lng: 75.7840 },
    distance: 1.1, timestamp: new Date(Date.now() - 2 * 3600000), aiTag: 'Electricity Hazard', aiConfidence: 93,
    status: 'pending', upvotes: 55, comments: [],
    severity: 10, type: 'electricity', priority: 'high', hasUserUpvoted: false, assignedDept: 'ELECT',
  },
  {
    id: 's20', title: 'Stray cattle blocking Dewas Gate Road',
    description: 'Large number of stray cattle blocking traffic on Dewas Gate Road causing accidents.',
    imageUrl: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400',
    media: [{ id: 's20-1', type: 'image', url: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400' }],
    district: 'Ujjain', ward: 'Ward 8 - Dewas Gate', street: 'Dewas Gate Road', coordinates: { lat: 23.1855, lng: 75.7912 },
    distance: 0.9, timestamp: new Date(Date.now() - 4 * 3600000), aiTag: 'Animal Nuisance', aiConfidence: 90,
    status: 'submitted', upvotes: 36, comments: [],
    severity: 7, type: 'animal', priority: 'medium', hasUserUpvoted: false, assignedDept: 'ANIMAL',
  },
  {
    id: 's21', title: 'Sewage pipe burst near Nanakheda colony',
    description: 'Main sewage pipe burst causing raw sewage flooding near residential area.',
    imageUrl: 'https://i.pinimg.com/736x/15/df/d1/15dfd142e3abbe1c12f55b8dbdb4a5b7.jpg?w=400',
    media: [{ id: 's21-1', type: 'image', url: 'https://i.pinimg.com/736x/15/df/d1/15dfd142e3abbe1c12f55b8dbdb4a5b7.jpg?w=400' }],
    district: 'Ujjain', ward: 'Ward 7 - Nanakheda', street: 'Nanakheda Main Road', coordinates: { lat: 23.1900, lng: 75.7780 },
    distance: 1.6, timestamp: new Date(Date.now() - 11 * 3600000), aiTag: 'Sewage Problem', aiConfidence: 88,
    status: 'acknowledged', upvotes: 42, comments: [],
    severity: 8, type: 'sewage', priority: 'high', hasUserUpvoted: false, assignedDept: 'SEWAGE',
  },
  ...
  {
    id: 's22', title: 'Fire at illegal warehouse - Near Govindpura',
    description: 'Large fire at illegal chemical warehouse near Govindpura industrial area. Toxic fumes spreading.',
    imageUrl: 'https://i.pinimg.com/736x/e6/6a/0d/e66a0d8d5c93ef89b5e89da49a08bfa3.jpg?w=400',
    media: [{ id: 's22-1', type: 'image', url: 'https://i.pinimg.com/736x/e6/6a/0d/e66a0d8d5c93ef89b5e89da49a08bfa3.jpg?w=400' }],
    district: 'Bhopal', ward: 'Ward 50 - Govindpura', street: 'Govindpura Industrial Area', coordinates: { lat: 23.2690, lng: 77.4751 },
    distance: 3.1, timestamp: new Date(Date.now() - 30 * 60000), aiTag: 'Fire Hazard', aiConfidence: 97,
    status: 'acknowledged', upvotes: 91, comments: [{ id: 'c12', text: 'Please evacuate area immediately', timestamp: new Date(), author: 'Concerned Citizen' }],
    severity: 10, type: 'fire', priority: 'high', hasUserUpvoted: false, assignedDept: 'FIRE',
  },
  {
    id: 's23', title: 'Electricity transformer fault - Kolar area',
    description: 'Transformer sparking and making loud noise near residential area. Fire risk.',
    imageUrl: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400',
    media: [{ id: 's23-1', type: 'image', url: 'https://i.pinimg.com/736x/34/9a/2a/349a2af0fdace073b68cae9df2ec7cad.jpg?w=400' }],
    district: 'Bhopal', ward: 'Ward 44 - Kolar Road', street: 'Kolar Colony', coordinates: { lat: 23.1830, lng: 77.4650 },
    distance: 2.3, timestamp: new Date(Date.now() - 5 * 3600000), aiTag: 'Electricity Hazard', aiConfidence: 92,
    status: 'submitted', upvotes: 44, comments: [],
    severity: 9, type: 'electricity', priority: 'high', hasUserUpvoted: false, assignedDept: 'ELECT',
  },
  {
    id: 's24', title: 'Stray dogs menace near Van Vihar Road',
    description: 'Several stray dogs attacking cyclists and morning walkers near Van Vihar entrance.',
    imageUrl: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400',
    media: [{ id: 's24-1', type: 'image', url: 'https://i.pinimg.com/736x/3c/40/97/3c40972c06dccc4a0093f9c4a99b6b8a.jpg?w=400' }],
    district: 'Bhopal', ward: 'Ward 2 - Van Vihar', street: 'Van Vihar Road', coordinates: { lat: 23.2135, lng: 77.3825 },
    distance: 0.8, timestamp: new Date(Date.now() - 6 * 3600000), aiTag: 'Animal Nuisance', aiConfidence: 93,
    status: 'pending', upvotes: 38, comments: [],
    severity: 8, type: 'animal', priority: 'high', hasUserUpvoted: false, assignedDept: undefined,
  },
];
